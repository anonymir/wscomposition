...
<div class="panel" style="padding:10px; margin-bottom:10px;">
	<form id="selection-generer-form">
		<div class="row">
			...
			<div class="col-lg-6">
				<div class="input-group" style="direction:ltr; margin-bottom:3px; width:100%;">
					<span class="input-group-addon bg-blue-grey-200 blue-grey-800 text-left" style="width:200px;">Collection de compositions</span>
					<input class="form-control" type="file" name="compositions" id="corpus" />
				</div>
			</div>
			<div class="col-lg-6">
				<div class="input-group" style="direction:ltr; margin-bottom:3px; width:100%;">
					<span class="input-group-addon bg-blue-grey-200 blue-grey-800 text-left" style="width:200px;">Algorithme de sélection</span>
					<input class="form-control" type="text" name="algorithme" value="http://localhost:51002/ServiceSelection.asmx?WSDL" />
				</div>
			</div>
			<div class="col-lg-6">
				<div class="input-group" style="direction:ltr; margin-bottom:3px; width:100%;">
					<span class="input-group-addon bg-blue-grey-200 blue-grey-800 text-left" style="width:200px;">Temps d'exécution</span>
					<input class="form-control" type="text" name="temps" value="< 5000ms" />
				</div>
			</div>
			<div class="col-lg-6">
				<div class="input-group" style="direction:ltr; margin-bottom:3px; width:100%;">
					<span class="input-group-addon bg-blue-grey-200 blue-grey-800 text-left" style="width:200px;">Coût</span>
					<input class="form-control" type="text" name="cout" value="< 200$" />
				</div>
			</div>
			<div class="col-lg-6">
				<div class="input-group" style="direction:ltr; margin-bottom:3px; width:100%;">
					<span class="input-group-addon bg-blue-grey-200 blue-grey-800 text-left" style="width:200px;">Disponibilité</span>
